      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            SwitchListTile(title: const Text('Push Notifications'), value: true, onChanged: (v) {}, activeColor: const Color(0xFF007AFF)),
            SwitchListTile(title: const Text('Scan Reminders'), value: false, onChanged: (v) {}, activeColor: const Color(0xFF007AFF)),
            SwitchListTile(title: const Text('Backup Alerts'), value: true, onChanged: (v) {}, activeColor: const Color(0xFF007AFF)),
            const SizedBox(height: 12),
          ],
        ),
      ),
